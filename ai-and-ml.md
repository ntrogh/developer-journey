...
| Name/Link | Description | Level |
| --- | --- | --- |
| [AI Reference Architectures](https://docs.microsoft.com/en-us/azure/architecture/reference-architectures/#ai-and-machine-learning) | Reference architectures for AI and machine learning. | 200 |
| [AI Solution Architectures](https://azure.microsoft.com/en-us/solutions/architecture/?tag=artificial-intelligence) | Solution architectures for AI-based applications. | 200 |
| [Dev Guide to building AI Apps eBook](https://info.microsoft.com/ww-landing-ai-developers-bot-ebook.html) | eBook on how to build AI applications. | 200 |
| [Microsoft AI School](https://aischool.microsoft.com/en-us/home) | Whether you’re completely new to AI or a seasoned professional looking to stay on top of your game, AI School is quite simply the best place to find the information, learning materials and resources you need to start building intelligence into your solutions. | 200 |
| [AI Show](https://channel9.msdn.com/Shows/AI-Show) | AI Show on Channel9, a video channel on AI product updates and insights into AI use cases. | 200 |
| [Getting started with the DSVM](https://docs.microsoft.com/en-us/learn/paths/get-started-with-azure-dsvm/) | MS Learn learning path to get started with machine learning using an Azure Data Science Virtual Machine. | 200-300 |
| [Machine Learning on Coursera](https://www.coursera.org/learn/machine-learning) | Coursera course on machine learning where you will learn about the most effective machine learning techniques, and gain practice implementing them and getting them to work for yourself. | 200-300 |
...
| --- | --- | --- |
| [AI Show](https://channel9.msdn.com/Shows/AI-Show) | AI Show on Channel9, a video channel on AI product updates and insights into AI use cases. | 200 |
| [AI with Azure ML services](https://azure.microsoft.com/en-us/resources/videos/ignite-2018-ai-with-azure-machine-learning-services-simplifying-the-data-science-process/) | The process of developing machine learning models for production involves many steps. It is often embedded in a complex flow to acquire and prepare the data on the one side and to post-process and deploy the model on the other. Learn how you simplify this end-to-end process using Azure ML services. | 200 |
| [Microsoft AI Overview](https://azure.microsoft.com/en-us/resources/videos/build-2018-microsoft-ai-overview-for-developers/) | Get an overview of the different AI services that allow developers to infuse AI in their applications. | 200 |
...
| Name/Link | Description | Level |
| --- | --- | --- |
| [Cognitive Services Bootcamp](https://github.com/Azure/LearnAI-Bootcamp) | Build an Intelligent Search Solution for Images using Microsoft AI Platform. | 300 |
| [Classify images with Cognitive Services](https://docs.microsoft.com/en-us/learn/paths/classify-images-with-vision-services/) | Learn how to use the Cognitive Vision Services to detect faces, tag and classify images, and identify objects. | 300 |
| [Interactive Deep Learning](https://docs.microsoft.com/en-us/learn/modules/interactive-deep-learning/) | Learn to train deep learning models with Jupyter, PyTorch and the Data Science Virtual Machine. | 300 |
| [Custom AI hands-on lab](https://azure.github.io/LearnAI_Azure_ML/) | A hands-on deep-dive on technologies as Azure Databricks (ADB), Azure Machine Learning (AML) Services and Azure DevOps, with the goal of creating, deploying and maintaining end-to-end data science and AI solutions. | 300 |
...
| [MCW Intelligent Analytics](https://github.com/Microsoft/MCW-Intelligent-Analytics) | In this workshop you will learn real-time analytics without IoT. You'll enable intelligent conversation in a machine learning enabled, real-time chat pipeline, and apply analytics to visualize customer sentiment in real time for hotel guests, allowing them to chat with one another, and to communicate directly with the concierge. You'll apply analytics to visualize customer sentiment in real-time, as well as view trending sentiment over time and create a bot that can answer questions and embed it in the custom web app. | 300 |
| [Explore AI Labs source code](https://github.com/Microsoft/ailab) | AI Lab helps our large fast-growing community of developers get started on AI. You can experience, learn and code the latest and greatest innovations from Microsoft AI here. AI Lab currently houses eight projects that showcase the latest in custom vision, attnGAN, Visual Studio tools for AI, Cognitive Search, Machine Reading Comprehension and more. Each lab gives you access to the experimentation playground, source code on GitHub, a crisp developer-friendly video, and insights into the underlying developer/ organizational challenge and solution. | 300 |
